    ...
    <>
      <div className="py-16 flex md:flex-row flex-col justify-around items-center md:gap-0 gap-4 text-center">
        <div className="flex items-center">
          <span className="relative text-4xl text-indigo-600 before:content-[''] before:absolute before:w-8 before:h-8 before:bg-gray-100 before:rounded-full before:-z-10 before:top-[10px] before:-right-[22px] before:transform before:-translate-x-1/2 before:-translate-y-1/2">
            <TbTruckDelivery />
          </span>
          <p className="pl-3 text-xl font-bold text-zinc-800 text-left leading-6">
